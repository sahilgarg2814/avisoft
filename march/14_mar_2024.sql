...
create table locations(location_id int,street_address varchar(200),postal_code varchar(200),city varchar(100),state_province varchar(100),country_id varchar(10));
...
create table countries(country_id varchar(50),country_name varchar(100),region_id int);
...
select l.location_id,l.street_address,l.city,l.state_province,c.country_name from locations as l join countries as c on l.country_id=c.country_id order by l.location_id;

-- 2.Write a MySQL query to find the name (first_name, last name), department ID and name of all the employees.


create table employees(EMPLOYEE_ID int,FIRST_NAME varchar(100),LAST_NAME VARCHAR(100),EMAIL VARCHAR(100),PHONE_NUMBER VARCHAR(100),HIRE_DATE date,JOB_ID VARCHAR(100),SALARY double,COMMISSION_PCT float,MANAGER_ID INT,DEPARTMENT_ID INT);

create table departments(DEPARTMENT_ID int,DEPARTMENT_NAME varchar(100),MANAGER_ID varchar(100),LOCATION_ID int);
...
(205, 'Shelley', 'Higgins', 'SHIGGINS', '515.123.8080', '1987-09-30', 'AC_MGR', 1000.00, 0.00, 101,110),
